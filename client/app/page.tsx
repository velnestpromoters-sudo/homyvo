...
export default function Root() {
  ...
  // To avoid hydration mismatch while loading tokens, handle the logic inside useEffect
  useEffect(() => {
    ...
    const timer = setTimeout(() => {
      if (!isAuthenticated) {
        ...
        if (role === 'tenant') {
           router.push('/tenant/home'); // Or /home if user hasn't defined standard routes
        } else if (role === 'owner') {
